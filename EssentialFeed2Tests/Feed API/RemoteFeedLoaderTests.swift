...
class RemoteFeedLoaderTests: XCTestCase {
    ...
    func test_load_deliversNoItemsOn200HTTPRepsonseWithEmptyJSONList() {
        let (sut, client) = makeSUT()
    ...
    private func expect(_ sut:RemoteFeedLoader, toCompleteWith
                            expectedResult:RemoteFeedLoader.Result, when action: ()-> Void, file: StaticString = #file, line:UInt = #line) {
    ...
    private class HTTPClientSpy:HTTPClient {
        ...
        func complete(withStatusCode code:Int, data: Data, at index:Int = 0 ) {
            let response = HTTPURLResponse(
                url: requestedURLs[index], statusCode: code,
                httpVersion: nil,
                headerFields: nil
            )!
