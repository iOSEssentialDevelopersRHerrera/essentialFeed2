...
//
//  Created by Ricardo Herrera Petit on 1/13/21.
//
...
class EssentialFeedCacheIntegrationTests: XCTestCase {
    ...
    func test_save_overridesItemSavedOnASeperateInstance() {
        ...
        let saveExp1 = expectation(description: "Wait for completion")
        ...
        sutToPerformLastSave.save(latestFeed) { saveError in
            XCTAssertNil(saveError, "xpected to save successfully")
            saveExp2.fulfill()
        }
