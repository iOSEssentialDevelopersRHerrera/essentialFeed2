...
class FeedImageDataLoaderWithFallbackCompositeTests: XCTestCase {
    ...
    private func makeSUT(file: StaticString = #file, line: UInt = #line) -> (sut: FeedImageDataLoaderComposite, primary: FeedImageDataLoaderSpy, fallback: FeedImageDataLoaderSpy) {
